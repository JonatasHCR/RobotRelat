...
from app.controller.controller_cliente import ControllerCliente
...
class ViewCliente:
    ...
    def janela_form(self, janela: ctk.CTkToplevel) -> None:
        ...
        self.components.criar_entrys(
            ["Nome", "Centro de Custo", "Descrição"], coluna, linha + 1, janela
        )
        self.components.criar_entry_opcao(
            janela, coluna, linha + 4, self.utils.tipo_cliente, "Tipo de Cliente"
        )
    ...
    def janela_alterar(self, janela: ctk.CTkToplevel, pagina: int):
        ...
        for cliente in clientes:
            ...
            self.components.criar_botao(
                "Deletar",
                lambda cliente=cliente: self.popup_deletar(janela, cliente),
                coluna - 1,
                linha,
                janela,
            )
        ...
        def popup_confirmacao() -> None:
            ...
            texto = ctk.CTkLabel(
                janela_popup,
                text="Tem certeza que deseja alterar os dados dos clientes ?",
            )
