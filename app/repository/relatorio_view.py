...
class RelatorioView:
    ...
    def retirar_total_periodo(
        ...
        try:
            ...
            dicionario_periodo = dict(
                [("PAGOS 1-10", 0), ("PAGOS 11-20", 0), (f"PAGOS 21-{total_dias}", 0)]
            )
            dicionario = dict(
                [
                    ("Próprio", dicionario_periodo.copy()),
                    ("Consórcio", dicionario_periodo.copy()),
                ]
            )
